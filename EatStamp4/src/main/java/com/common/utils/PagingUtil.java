...
public class PagingUtil {
	...
	public PagingUtil(String keyfield, String keyword, int currentPage, int count, int rowCount,
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (i == currentPage) {
				page.append("&nbsp;<b><span style='color:#839589; position: relative; bottom: 1px;'>");
				page.append(i);
				page.append("</span></b>");
			} else {
	...
	public PagingUtil(String c_category, String keyfield, String keyword, int currentPage, int count, int rowCount,
			int pageCount,String pageUrl) {
		String sub_url = "";
		if(keyword != null) sub_url = "&keyfield="+keyfield+"&keyword="+keyword;
		if(c_category != null) sub_url = "&c_category="+c_category;
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (i == currentPage) {
				page.append("&nbsp;<b><span style='color:#839589;'>");
				page.append(i);
				page.append("</span></b>");
			} else {
				page.append("&nbsp;<a href='"+pageUrl+"?pageNum=");
